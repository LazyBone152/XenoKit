...
{
    public class BACType30ViewModel : ObservableObject, IDisposable
    {
        ...
        public float F_08
        {
            ...
            set
            {
                UndoManager.Instance.AddUndo(new UndoableProperty<BAC_Type28>(nameof(bacType.F_08), bacType, bacType.F_08, value, "F_08"));
                bacType.F_08 = value;
        ...
        public int I_16
        {
            ...
            set
            {
                UndoManager.Instance.AddUndo(new UndoableProperty<BAC_Type28>(nameof(bacType.I_16), bacType, bacType.I_16, value, "I_16"));
                bacType.I_16 = value;
        ...
        public int I_20
        {
            ...
            set
            {
                UndoManager.Instance.AddUndo(new UndoableProperty<BAC_Type28>(nameof(bacType.I_20), bacType, bacType.I_20, value, "I_20"));
                bacType.I_20 = value;
        ...
        public int I_36
        {
            ...
            set
            {
                UndoManager.Instance.AddUndo(new UndoableProperty<BAC_Type28>(nameof(bacType.I_36), bacType, bacType.I_36, value, "I_36"));
                bacType.I_36 = value;
        ...
        public int I_40
        {
            ...
            set
            {
                UndoManager.Instance.AddUndo(new UndoableProperty<BAC_Type28>(nameof(bacType.I_40), bacType, bacType.I_40, value, "I_40"));
                bacType.I_40 = value;
        ...
        public int I_44
        {
            ...
            set
            {
                UndoManager.Instance.AddUndo(new UndoableProperty<BAC_Type28>(nameof(bacType.I_44), bacType, bacType.I_44, value, "I_44"));
                bacType.I_44 = value;
