...
namespace XenoKit.Views.BAC
{
    ...
    /// </summary>
    public partial class BacType12View : UserControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty BacViewModelProperty = DependencyProperty.Register(
            nameof(BacViewModel), typeof(BACType12ViewModel), typeof(BacType12View), new PropertyMetadata(default(BACType12ViewModel)));

        public BACType12ViewModel BacViewModel
        {
            get { return (BACType12ViewModel)GetValue(BacViewModelProperty); }
            set
            {
