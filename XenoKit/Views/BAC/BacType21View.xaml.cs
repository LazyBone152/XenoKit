...
namespace XenoKit.Views.BAC
{
    ...
    /// </summary>
    public partial class BacType21View : UserControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty BacViewModelProperty = DependencyProperty.Register(
            "BacViewModel", typeof(BACType21ViewModel), typeof(BacType21View), new PropertyMetadata(default(BACType21ViewModel)));

        public BACType21ViewModel BacViewModel
        {
            get { return (BACType21ViewModel)GetValue(BacViewModelProperty); }
            set
            {
