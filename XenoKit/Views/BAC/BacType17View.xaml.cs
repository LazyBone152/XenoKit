...
namespace XenoKit.Views.BAC
{
    ...
    /// </summary>
    public partial class BacType17View : UserControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty BacViewModelProperty = DependencyProperty.Register(
            nameof(BacViewModel), typeof(BACType17ViewModel), typeof(BacType17View), new PropertyMetadata(default(BACType17ViewModel)));

        public BACType17ViewModel BacViewModel
        {
            get { return (BACType17ViewModel)GetValue(BacViewModelProperty); }
            set
            {
