...
namespace XenoKit.Views.BAC
{
    ...
    /// </summary>
    public partial class BacType13View : UserControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty BacViewModelProperty = DependencyProperty.Register(
            nameof(BacViewModel), typeof(BACType13ViewModel), typeof(BacType13View), new PropertyMetadata(default(BACType13ViewModel)));

        public BACType13ViewModel BacViewModel
        {
            get { return (BACType13ViewModel)GetValue(BacViewModelProperty); }
            set
            {
