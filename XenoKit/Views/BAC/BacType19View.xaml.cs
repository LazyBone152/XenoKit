...
namespace XenoKit.Views.BAC
{
    ...
    /// </summary>
    public partial class BacType19View : UserControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty BacViewModelProperty = DependencyProperty.Register(
            "BacViewModel", typeof(BACType19ViewModel), typeof(BacType19View), new PropertyMetadata(default(BACType19ViewModel)));

        public BACType19ViewModel BacViewModel
        {
            get { return (BACType19ViewModel)GetValue(BacViewModelProperty); }
            set
            {
