...
namespace XenoKit.Views.BAC
{
    ...
    /// </summary>
    public partial class BacType27View : UserControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty BacViewModelProperty = DependencyProperty.Register(
            "BacViewModel", typeof(BACType27ViewModel), typeof(BacType27View), new PropertyMetadata(default(BACType27ViewModel)));

        public BACType27ViewModel BacViewModel
        {
            get { return (BACType27ViewModel)GetValue(BacViewModelProperty); }
            set
            {
