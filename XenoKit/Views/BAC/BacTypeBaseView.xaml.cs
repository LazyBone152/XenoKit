...
{
    /// <summary>
    /// Interaction logic for BacTypeBaseView.xaml
    /// </summary>
    public partial class BacTypeBaseView : UserControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty BacViewModelProperty = DependencyProperty.Register(
            "BacViewModel", typeof(BACTypeBaseViewModel), typeof(BacTypeBaseView), new PropertyMetadata(default(BACTypeBaseViewModel)));

        public BACTypeBaseViewModel BacViewModel
        {
            get { return (BACTypeBaseViewModel)GetValue(BacViewModelProperty); }
            set
            {
