...
namespace XenoKit.Views.BAC
{
    ...
    /// </summary>
    public partial class BacType22View : UserControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty BacViewModelProperty = DependencyProperty.Register(
            "BacViewModel", typeof(BACType22ViewModel), typeof(BacType22View), new PropertyMetadata(default(BACType22ViewModel)));

        public BACType22ViewModel BacViewModel
        {
            get { return (BACType22ViewModel)GetValue(BacViewModelProperty); }
            set
            {
