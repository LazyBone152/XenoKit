...
{
    /// <summary>
    /// Interaction logic for BacType2View.xaml
    /// </summary>
    public partial class BacType2View : UserControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty BacViewModelProperty = DependencyProperty.Register(
            "BacViewModel", typeof(BACType2ViewModel), typeof(BacType2View), new PropertyMetadata(default(BACType2ViewModel)));

        public BACType2ViewModel BacViewModel
        {
            get { return (BACType2ViewModel)GetValue(BacViewModelProperty); }
            set
            {
