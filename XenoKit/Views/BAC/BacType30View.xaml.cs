...
namespace XenoKit.Views.BAC
{
    ...
    /// </summary>
    public partial class BacType30View : UserControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty BacViewModelProperty = DependencyProperty.Register(
            "BacViewModel", typeof(BACType30ViewModel), typeof(BacType30View), new PropertyMetadata(default(BACType30ViewModel)));

        public BACType30ViewModel BacViewModel
        {
            get { return (BACType30ViewModel)GetValue(BacViewModelProperty); }
            set
            {
