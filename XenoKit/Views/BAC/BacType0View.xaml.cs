...
namespace XenoKit.Views.BAC
{
    ...
    /// </summary>
    public partial class BacType0View : UserControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty BacViewModelProperty = DependencyProperty.Register(
            "BacViewModel", typeof(BACType0ViewModel), typeof(BacType0View), new PropertyMetadata(default(BACType0ViewModel)));
        
        public BACType0ViewModel BacViewModel
        {
            get { return (BACType0ViewModel)GetValue(BacViewModelProperty); }
            set
            {
