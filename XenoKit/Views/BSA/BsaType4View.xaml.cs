...
{
    public partial class BsaType4View : UserControl, INotifyPropertyChanged
    {
        public event PropertyChangedEventHandler PropertyChanged;

        public static readonly DependencyProperty ViewModelProperty = DependencyProperty.Register(
            nameof(ViewModel), typeof(BsaType4ViewModel), typeof(BsaType4View), new PropertyMetadata(null, ViewModelChanged));

        public BsaType4ViewModel ViewModel
        {
            get => (BsaType4ViewModel)GetValue(ViewModelProperty);
            set
            {
        ...
        {
            BsaType4View view = (BsaType4View)sender;
