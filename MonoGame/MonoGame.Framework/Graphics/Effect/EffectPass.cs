...
namespace Microsoft.Xna.Framework.Graphics
{
    public class EffectPass
    {
        ...
        public void Apply()
        {
            ...
            //if shader changes during OnApply, then restart?
            ...
            if (_vertexShader != null)
            {
                ...
                for (var c = 0; c < _vertexShader.CBuffers.Length; c++)
                {
                    ...
                    device.SetConstantBuffer(ShaderStage.Vertex, (_effect.ConstantBuffers[_vertexShader.CBuffers[c]].Slot != -1) ? _effect.ConstantBuffers[_vertexShader.CBuffers[c]].Slot : c, cb);
            ...
            if (_pixelShader != null) 
            {
                ...
                for (var c = 0; c < _pixelShader.CBuffers.Length; c++)
                {
                    ...
                    cb.Update(_effect.Parameters);
                    device.SetConstantBuffer(ShaderStage.Pixel, (_effect.ConstantBuffers[_pixelShader.CBuffers[c]].Slot != -1) ? _effect.ConstantBuffers[_pixelShader.CBuffers[c]].Slot : c, cb);
