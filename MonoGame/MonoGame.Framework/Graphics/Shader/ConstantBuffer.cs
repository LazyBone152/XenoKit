...
namespace Microsoft.Xna.Framework.Graphics
{
    public partial class ConstantBuffer : GraphicsResource
    {
        ...
        private readonly int[] _parameters; //Index of parameter in EffectParameterCollection

        private readonly int[] _offsets; //Offset of parameter/data in buffer
            ...
            else if (param.Data != null)
            {
                switch (param.ParameterType)
                {
                    ...
                    case EffectParameterType.Bool:
                        ...
                        if (param.ParameterClass == EffectParameterClass.MatrixColumnsMajor)
                        {
